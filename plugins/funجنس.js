let handler = async (m, { conn, command, text }) => {
  ...
  conn.reply(m.chat, `
🤤👅🥵 *انت لسه خلصت على الـ@ دا!*🥵👅🤤

*انت لسه عملت معاه الواجب* *${text}* ⁩ *نكتها وهي بتعيط زي الكلبة "آه آه كمل كمل متوقفش" وخلتها تعبانة لدرجة مش عارفة تشيل جسمها يا الزانية!*
